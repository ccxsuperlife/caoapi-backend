package com.cao.api.controller;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.cao.api.annotation.AuthCheck;
import com.cao.api.common.*;
import com.cao.api.constant.CommonConstant;
import com.cao.api.constant.UserConstant;
import com.cao.api.exception.BusinessException;
import com.cao.api.model.dto.interfaceinfo.InterfaceInfoAddRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        //调用接口，判断是否存在
        com.cao.caoapiclientsdk.model.User user = new com.cao.caoapiclientsdk.model.User();
        String username = caoApiClient.getUserNameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        //创建一个临时的CaoApiClient对象，用于存储ak和sk
        CaoApiClient caoApiClient = new CaoApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.cao.caoapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.cao.caoapiclientsdk.model.User.class);
        String userNameByPost = caoApiClient.getUserNameByPost(user);

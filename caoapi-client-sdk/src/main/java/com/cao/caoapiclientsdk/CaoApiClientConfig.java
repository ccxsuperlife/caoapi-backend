package com.cao.caoapiclientsdk;
...
// 这里给所有的配置加上前缀为"caoapi.client"
@ConfigurationProperties("caoapi.client")
// @Data 注解是一个 Lombok 注解,自动生成了类的getter、setter方法
@Data
// @ComponentScan 注解用于自动扫描组件，使得 Spring 能够自动注册相应的 Bean
@ComponentScan
public class CaoApiClientConfig {
    ...
    @Bean
    public CaoApiClient caoApiClient() {
        return new CaoApiClient(accessKey, secretKey);
    }
